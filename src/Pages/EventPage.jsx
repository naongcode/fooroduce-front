...
const EventHeader = () => {
  ...
  return (
    <div className="relative w-full h-[250px] sm:h-[300px] overflow-hidden">
      ...
      {/* 텍스트 & 탭 영역 */}
      <div className="absolute inset-0 flex flex-col justify-center items-center px-2 text-center sm:px-4">
        <h1
          className="text-2xl sm:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-purple-200 via-orange-200 to-yellow-300 bg-clip-text text-transparent break-words"
        >
          {eventData?.eventName}
        </h1>
...
const EventTabs = () => {
  ...
  const baseClasses =
    'px-4 sm:px-6 py-2 text-sm sm:text-base rounded-lg font-medium transition-all duration-300 whitespace-nowrap cursor-pointer text-center w-full sm:w-auto'
